...
casper.thenOpen(url + '/rhn/activationkeys/Edit.do?tid=2', function() {
    this.captureSelector('images/systems/systems_activation_key_details.png', '#spacewalk-content')});

// Systems: Act Key Child Channels
casper.thenOpen(url + '/rhn/activationkeys/channels/ChildChannels.do?tid=2', function() {
...
casper.thenOpen(url + '/rhn/activationkeys/configuration/List.do?tid=2', function() {
...
casper.thenOpen(url + '/rhn/activationkeys/configuration/Subscribe.do?tid=2', function() {
...
casper.thenOpen(url + '/rhn/activationkeys/systems/List.do?tid=2', function() {
