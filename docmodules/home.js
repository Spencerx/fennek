...
casper.thenOpen(url + '/rhn/YourRhn.do').waitForText("View All Recently Registered Systems", function() {
    this.captureSelector('images/home/overview/home_overview.png', '#spacewalk-content')
});
...
casper.thenOpen(url + '/rhn/account/Addresses.do', function() {
    this.captureSelector('images/home/user-account/home_user_account_personal_info.png', '#spacewalk-content')
});
